...
{
    public class TabsModel : ReactiveObject, IObservable<int>, ITabsModel
    {
        readonly ReplaySubject<int> selectedIndex = new(1);
        private readonly TabsRepository tabsRepository;

        public TabsModel(TabsRepository tabsRepository, ITreeItemChanges treeService, ITabsFactory tabsFactory)
        {
