using SQLite.WPF.Resources.Localisation;
...
namespace SQLiteKei.Helpers
{
    ...
    public static class LocalisationHelper
    {
        ...
        {
            return Resources.ResourceManager.GetObject(key) as string;
        }
        ...
        {
            var localizedString = Resources.ResourceManager.GetObject(key) as string;
