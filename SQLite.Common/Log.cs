...
namespace SQLite.Common
{
    public static class Log
    {
        ...
        public static void Debug(object message, Exception exception) => Logger.Debug(message, exception);

        public static void Info(object message) => Logger.Info(message);

        public static void Info(object message, Exception exception) => Logger.Info(message, exception);

        public static void Warn(object message) => Logger.Warn(message);

        public static void Warn(object message, Exception exception) => Logger.Warn(message, exception);
        ...
        public static void Fatal(object message, Exception exception) => Logger.Fatal(message, exception);
    }
}
